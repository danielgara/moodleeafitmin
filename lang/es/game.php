...
/**
 * Strings for component 'game', language 'es', branch 'MOODLE_39_STABLE'
 *
 * @package   game
...
$string['helpcross'] = 'Este juego obtiene palabras de un Glosariio o de preguntas de respuesta corta para cuestionario, y genera un crucigrama aleatorio. El profesor puede configurar el número máximo de  columas/filas o palabras que contiene. El estudiante puede pulsar el botón "Revisar crucigrama" para revisar si sus respuestas son correctas. Cada crucigrama es dinámico, por lo que es diferente para cada estudiante.';
...
$string['helphangman'] = 'Este juego obtiene palabras de un Glosariio o de preguntas de respuesta corta de examen, y genera un acertijo de ahorcado. El profesor puede configurar el número de palabras que tiene cada juego, si se muestra la primera o la última letra o si se muestra la pregunta o la respuesta al final.';
...
$string['must_select_quiz'] = 'Usted debe seleccionar un examen';
$string['nextgame'] = 'Siguiente juego';
$string['nextword'] = 'Siguiente palabra';
$string['noattempts'] = 'Usted debe seleccionar un juego';
