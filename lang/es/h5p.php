...
/**
 * Strings for component 'h5p', language 'es', branch 'MOODLE_39_STABLE'
 *
 * @package   h5p
...
$string['missinglibraryjson'] = 'No se pudo encontrar el archivo library.json con formato json válido para librería {$a->%name}';
