...
/**
 * Strings for component 'jitsi', language 'es', branch 'MOODLE_39_STABLE'
 *
 * @package   jitsi
...
$string['streamingbuttonex'] = 'Mostrar opción streaming. (Solo para profesores)';
$string['tokenconfigurationex'] = 'Vacío para servidores sin token';
$string['tokennconfig'] = 'Configuración por Token';
$string['username'] = 'Nombre de Usuario';
$string['watermarklink'] = 'Link marca de agua';
$string['watermarklinkex'] = 'Link marca de agua';
$string['youtubebutton'] = 'Opción compartir Youtube';
$string['youtubebuttonex'] = 'Mostrar opción compartir Youtube';
