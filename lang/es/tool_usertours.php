...
/**
 * Strings for component 'tool_usertours', language 'es', branch 'MOODLE_39_STABLE'
 *
...
$string['tour3_content_overview'] = 'El bloque de "Información General del Curso" muestra todos los cursos en los que se está inscrito.

Puede elegir mostrar los cursos actualmente en curso, en el pasado o en el futuro, o los cursos que se han destacado.';
